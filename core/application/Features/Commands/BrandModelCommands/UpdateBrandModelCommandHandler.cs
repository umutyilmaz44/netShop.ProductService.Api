...
{
    public class UpdateBrandModelCommandHandler : IRequestHandler<UpdateBrandModelCommand, Response>
    {
        IMapper mapper;
        ...
        public async Task<Response> Handle(UpdateBrandModelCommand request, CancellationToken cancellationToken)
        {
            if (request == null)
            {
